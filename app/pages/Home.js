    ...
    <>
      <div className="marq">
        ...
        <marquee>
          ...
          landfall along Bangladesh Coast in early hours of November 18 Cyclone
          Midhili to make landfall along Bangladesh Coast in early hours of
          November 18 Hamoon: Odisha prepares for brewing cyclonic storm; sends
          out warnings to farmers, fisherfolk Light to moderate rain is likely
          to lash the coastal districts of Odisha Isolated heavy rainfall over
          Mizoram and heavy to very rainfall over Tripura expected on October 23
          and 24
        </marquee>
      </div>
      <div className="container">
        ...
        <p>
          ...
          caused either by rapid or slow onset events that have immediate
          impacts on human health and secondary impacts causing further death
          ...
          duration and usually affect a relatively small region whereas droughts
        ...
        <p>
          ...
          complex combination of both natural and man-made causes which involve
          a break-down of authority, looting and attacks on strategic
          ...
          characterized by a combination of factors that present specific risks
          to the affected population, including:
          <ol>
        ...
        <p>
          ...
          activities which intend to prevent or avoid potential adverse impacts
          through action taken in advance, activities designed to provide
          protection from the occurrence of disasters [1]. WCPT similarly
          ...
          Reduction, which was adopted in 2005 as a 10 year Global Plan, signed
          by agreement with 168 Governments which offered guiding principles,
          priorities for action and practical means for achieving disaster
        ...
        <p>
          ...
          those disasters on the vulnerable populations that may be affected so
          they can effectively cope. Disaster preparedness activities embedded
          with risk reduction measures can prevent disaster situations and also
          result in saving maximum lives and livelihoods during any disaster
          situation, enabling the affected population to get back to normalcy
          within a short time period. Minimisation of loss of life and damage to
          property through facilitation of effective disaster response and
          rehabilitation services when required. Preparedness is the main way of
          reducing the impact of disasters. Community-based preparedness and
          management should be a high priority in physical therapy practice
          management.
        </p>
      </div>
